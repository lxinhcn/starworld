...
#include <string>
#include <tchar.h>
//#include "../../../EngineSDK/ThirdPartyLibs/loki-0.1.6/include/loki/TypeManip.h"
//#include "../../../EngineSDK/ThirdPartyLibs/loki-0.1.6/include/loki/TypeTraits.h"
...
public:
	...
	inline bool	addpos( size_t delta )
	{ 
	...
	inline CNetInStream& write( size_t			val ){ return write< size_t >			(val); }
...
public:
	...
	inline const char* get_point()const{ return m_pbuf + m_nNowSite; }
