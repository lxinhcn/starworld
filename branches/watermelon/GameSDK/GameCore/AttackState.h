...
namespace XGC
{
	struct CORE_API AttackStateParams : public StateParams
	{
		xObject hSkill;
		xObject hTarget;
	};

	class CObjectAttackControler;
	class CORE_API CAttackState :	public CStateBase
	{
	public:
		CAttackState( byte_t code, const GuardFunctor& Fn );
		~CAttackState(void);
	...
	private:
		AttackStateParams		mStateParams;
	};
}