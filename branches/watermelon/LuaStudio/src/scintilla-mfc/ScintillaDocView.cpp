...
void CScintillaView::ShowLineNumber( bool bShow )
{
	if( bShow )
	{
		m_Edit.SetMarginTypeN( 0, SC_MARGIN_NUMBER );
		m_Edit.SetMarginWidthN( 0, 12*m_Edit.TextWidth( STYLE_LINENUMBER, " " ) );
	}
	else
	{
		m_Edit.SetMarginWidthN( 0, 0 );
	}
}
