...
namespace XGC
{
	namespace common
	{
		 ...
		 */
		class EXPORT_LIB SmallObjAllocator
		{
		protected:
		...
		*/
		...
		<
			...
			template <class> class LifetimePolicy = DEFAULT_SMALLOBJ_LIFETIME
		>
		class SmallObject : public SmallObjectBase< ThreadingModel, chunkSize, maxSmallObjectSize, objectAlignSize, LifetimePolicy >
		{
		...
		<
			...
			template <class> class LifetimePolicy = DEFAULT_SMALLOBJ_LIFETIME
		>
		class SmallValueObject : public SmallObjectBase< ThreadingModel, chunkSize, maxSmallObjectSize, objectAlignSize, LifetimePolicy >
		{
		protected:
