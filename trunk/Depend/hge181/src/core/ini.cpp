...
void CALL HGE_Impl::Ini_Se_string(const char *section, const char *name, const char *value)
{
	if(szIniFile[0]) WritePrivateProfileString(section, name, value, szIniFile);
}


char* CALL HGE_Impl::Ini_Ge_string(const char *section, const char *name, const char *def_val)
{
