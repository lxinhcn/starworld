...
..\Debug\MessageCreator.exe %version% -unicode -lib -md -prefix:cgc_ -implib:"cgc.lib" -incdir:".\inc" -libdir:"%libdir%" -I"..\..\Server\xgcBase\Common" -I"..\..\Public" cgc_c2g.txt cgc_g2c.txt
