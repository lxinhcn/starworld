...
public:
	...
	virtual	void		CALL	Ini_Se_string(const char *section, const char *name, const char *value);
	virtual	char*		CALL	Ini_Ge_string(const char *section, const char *name, const char *def_val);
