...
///************************************************************************/
//class TOOLLIB_API CXObjectList
//{
...
//{
//protected:
//	enum { classdeep = TBase::classdeep + 1 };
//	XObjTypeT()
//	{
//		ASSERT_MSG( IsTypeOf( 0 ), _T("错误的继承类型。") );
...
//class TOOLLIB_API CXObject
//{
//protected:
//	enum { classdeep = 0, classtype = 0 };
//	CXObject();
//	virtual	~CXObject();
//
//private:
...
//	static	int		GetPointType()				{ return 0;		}
//	virtual int		GetType()const				{ return 0;		}
//	virtual BOOL	IsType( DWORD dwType )const	{ return 0 == dwType;}
//	static	BOOL	IsTypeOf( DWORD dwType )	{ return 0 == dwType;}
//
