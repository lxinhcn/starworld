...
/*
	enum Stat
	{
		...
		ERR_USER_ABORT,				// u¿ytkownik przerwa?asemblacj?		ERR_UNDEF_ORIGIN,			// brak dyrektywy .ORG
		ERR_MACRONAME_REQUIRED,		// brak etykiety nazywaj¹cej makrodefinicj?		ERR_PARAM_ID_REDEF,			// nazwa parametru ju?zdefiniowana
	...
	enum InstrType	// rodzaj dyrektywy asemblera
	{
		...
		I_DCB,		// declare block
		I_RS,		// reserve space
		I_END,		// zakoñcz asemblacj?		I_ERROR,	// zg³oszenie b³êdu
	...
	static const TCHAR LOCAL_LABEL_CHAR;	// znak rozpoczynaj¹cy etykiet?lokaln?	static const TCHAR MULTIPARAM[];		// wielokropek - dowolna iloœæ parametrów
...
/*
	...
	{
		DF_NONE		  = 0x00,
		DF_ADDRESS	  = 0x01,	// adres przed instrukcj?		DF_CODE_BYTES = 0x02,	// przed instrukcj?jej kod i argumenty
